...
import { getAllInstituicoes } from '@/services/instituicao.service'
...
export default function DashboardCreateAlunoPage() {
  ...
  const initialData: Partial<AlunoFormData> = {
    ...
    instituicao_id: 0, // start as 0 (no institution selected)
  }
  ...
  const handleSave = async (data: AlunoFormData) => {
    ...
    try {
      ...
      setTimeout(() => router.push('/dashboard/alunos'), 1000)
    } catch (err: unknown) {
